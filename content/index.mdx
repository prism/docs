...
- Supports h2, sqlite, mysql, mariadb, postgres, and clickhouse databases.
...
- A dozen new parameters.
- Minecraft Tag support.
- Simple permissions.
- Significantly better logging of all block/entity/item data.
- Rollback, restore, and preview commands.
- Inspect, rollback, and restore wands.
- Virtual inventory to view or recover items from a lookup.
- Supports custom blocks/items from plugins like [CraftEngine](https://modrinth.com/plugin/craftengine)
- Report command for queue stats, explanations of partial, skipped modifications.
...
- Write-ahead log for data continuity during db outages.
- API.
