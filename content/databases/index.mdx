...
Prism writes data to your database in batches. A single writer is usually plenty because the default batch size is 2000. However, if you want extra write thoughput without changing batch size, you can enable parallel writes.
