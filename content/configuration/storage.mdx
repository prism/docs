...
Prism uses [HikariCP](https://github.com/brettwooldridge/HikariCP) for database connection pooling. Prism builds a configuration for you that's optimized for most use cases.

However, you can define a custom `hikari.properties` file in the plugin's configuration folder. 

<Callout type='info'>Using a hikari.properties file will override values Prism sets.</Callout>
