...
There are significant pros and cons for server-based databases versus file-based but whether those matter to you are up to you.
...
<Callout type='info'>This feature is limited to users who have database permission to create procedures/functions. That's common on shared hosts, especially in MySQL/MariaDB.</Callout>
