...
Data is deleted in "batches" for performance reasons. The limit and delay are both configurable.
...
When the delete statement runs, it looks for any rows matching your conditions that are between the lowest primary key + your limit, until that value reaches the maximum primary key.
